...
const AdminManagement = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("https://jays-lw.onrender.com/posts", post);
...
//  get all the users queries from the server
  useEffect(() => {
    axios.get("https://jays-lw.onrender.com/GetQuery").then((res) => setQueries(res.data))
  ...
  const handleImageChange = async (id) => {
    ...
    if (!newImageUrl) return;
      const res = await axios.put(`https://jays-lw.onrender.com/posts/${id}`, {
 ...
 // admin authentication 
  const fetchUsers = async () => {
    try {
      const response = await fetch('https://jays-lw.onrender.com/admin/users', {
        method: 'GET',
        headers: {
...
useEffect(() => {
  ...
  const deleteUser = async (id) => {
    try {
      const response = await fetch(`https://jays-lw.onrender.com/admin/users/${id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          email: adminEmail
  ...
  const removeAdmin = async (id) => {
    try {
      const response = await fetch(`https://jays-lw.onrender.com/admin/users/removeAdmin/${id}`, {
        method: "PUT",
        headers: {
          'Content-Type': 'application/json',
  ...
  const cancelPlan = async (id) => {
    try {
      const response = await fetch(`https://jays-lw.onrender.com/admin/users/cancelPlan/${id}`, {
        method: "PUT",
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleMarkAsRead = async (id) => {
      await axios.delete(`https://jays-lw.onrender.com/Query/${id}`);
  ...
  const handleDelete = async (postId) => {
    ...
    try {
      await axios.delete(`https://jays-lw.onrender.com/posts/${postId}`);
  ...
  const handleEdit = async (post, field) => {
    ...
    if (newValue !== null && newValue.trim() !== "") {
      try {
        ...
        await axios.put(`https://jays-lw.onrender.com/posts/${post._id}`, updatedPost);
